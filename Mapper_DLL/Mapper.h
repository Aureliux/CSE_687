...
extern "C" MAPPERDLL_API void export_map(string temppath, vector<string> str_v);		/*	Receives a temporary directory path and text line and returns a modified string containing
